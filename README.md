...
```sh
git clone https://github.com/aayushKulkarni1789/mynvimconfig.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/aayushKulkarni1789/mynvimconfig.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/aayushKulkarni1789/mynvimconfig.git "${env:LOCALAPPDATA}\nvim"
```
